...
class CourseHomePage extends StatefulWidget {
  const CourseHomePage({Key? key, this.subId}) : super(key: key);
  final subId;

  @override
  _CourseHomePageState createState() => _CourseHomePageState(subId);
}
...
class _CourseHomePageState extends State<CourseHomePage> {
  ...
  _CourseHomePageState(this.subId);
          ...
          FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                if (snapshot.hasData) {
                  ...
                  return data.isEmpty ? Center(child: Text("Soon We will update"),)
:
                    ListView.builder(
                    shrinkWrap: true,
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(children: [
                                ...
                                Text("${data[index].subject.subjectName}")
                              ],),
                            ),
                            ListTile(
                              dense: true,
                              ...
                              trailing: TextButton.icon(
                                  autofocus: true,
                                  onPressed: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>TestDescriptionPage(chaId: data[index].id,)));
